...
data_H1 = data(1:361);
dataH2 = data(362:722);
dataH3 = data(723:1083);
dataH4 = data(1084:1444);

figure
subplot(2,2,1);
histogram(data_H1);
title('Indexes for Hour 1');

subplot(2,2,2);
histogram(dataH2);
title('Indexes for Hour 2');

subplot(2,2,3);
histogram(dataH3);
title('Indexes for Hour 3');

subplot(2,2,4);
histogram(dataH4);
title('Indexes for Hour 4');
...
% data_top_Prueba5 = top_Prueba2(time_vector);
% top_Prueba6 = ImportDataMultipleChannels('ECG-27-04-8H.txt',3);
% data_top_Prueba6 = top_Prueba3(time_vector);
% top_Prueba7 = ImportDataMultipleChannels('ECG-4-05-8H.txt',3);
% data_top_Prueba7 = top_Prueba2(time_vector);
% 
% data_top = {data_top_Prueba1,data_top_Prueba2,data_top_Prueba3,data_top_Prueba4,data_top_Prueba5,data_top_Prueba6,data_top_Prueba7};
% n = length(data_top);
% indexes_top = cell(1,n);
% for i=1:n
%     data = data_top{i};
...
% 
% data_camiseta = {data_camiseta_Prueba1,data_camiseta_Prueba2,data_camiseta_Prueba3,data_camiseta_Prueba4,data_camiseta_Prueba5,data_camiseta_Prueba6,data_camiseta_Prueba7};
...
% 
% data_pantalon = {data_pantalon_Prueba1,data_pantalon_Prueba2,data_pantalon_Prueba3,data_pantalon_Prueba4,data_pantalon_Prueba5,data_pantalon_Prueba6,data_pantalon_Prueba7};
