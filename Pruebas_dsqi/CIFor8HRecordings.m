...
top_Prueba5 = ImportDataMultipleChannels('ECG-25-04-8H.txt',3);
data_top_Prueba5 = top_Prueba5(time_vector);
top_Prueba6 = ImportDataMultipleChannels('ECG-27-04-8H.txt',3);
data_top_Prueba6 = top_Prueba6(time_vector);
top_Prueba7 = ImportDataMultipleChannels('ECG-4-05-8H.txt',3);
data_top_Prueba7 = top_Prueba7(time_vector);
top_Prueba8 = ImportDataMultipleChannels('ECG-11-05-8H.txt',3);
data_top_Prueba8 = top_Prueba8(time_vector);
top_Prueba9 = ImportDataMultipleChannels('ECG-15-05-8H.txt',3);
data_top_Prueba9 = top_Prueba9(time_vector);
top_Prueba10 = ImportDataMultipleChannels('ECG-18-05-8H.txt',3);
data_top_Prueba10 = top_Prueba10(time_vector);
top_Prueba11 = ImportDataMultipleChannels('ECG-20-05-8H.txt',3);
data_top_Prueba11 = top_Prueba11(time_vector);
top_Prueba12 = ImportDataMultipleChannels('ECG-25-05-8H.txt',3);
data_top_Prueba12 = top_Prueba12(time_vector);
top_Prueba13 = ImportDataMultipleChannels('ECG-27-05-8H.txt',3);
data_top_Prueba13 = top_Prueba13(time_vector);
top_Prueba14 = ImportDataMultipleChannels('ECG-30-05-8H.txt',3);
data_top_Prueba14 = top_Prueba14(time_vector);
top_Prueba15 = ImportDataMultipleChannels('ECG-01-06-8H.txt',3);
...
camiseta_Prueba5 = ImportDataMultipleChannels('ECG-25-04-8H.txt',4);
data_camiseta_Prueba5 = camiseta_Prueba2(time_vector);
camiseta_Prueba6 = ImportDataMultipleChannels('ECG-27-04-8H.txt',4);
data_camiseta_Prueba6 = camiseta_Prueba3(time_vector);
camiseta_Prueba7 = ImportDataMultipleChannels('ECG-4-05-8H.txt',4);
data_camiseta_Prueba7 = camiseta_Prueba2(time_vector);
camiseta_Prueba8 = ImportDataMultipleChannels('ECG-11-05-8H.txt',4);
data_camiseta_Prueba8 = camiseta_Prueba8(time_vector);
camiseta_Prueba9 = ImportDataMultipleChannels('ECG-15-05-8H.txt',4);
data_camiseta_Prueba9 = camiseta_Prueba9(time_vector);
camiseta_Prueba10 = ImportDataMultipleChannels('ECG-18-05-8H.txt',4);
data_camiseta_Prueba10 = camiseta_Prueba10(time_vector);
camiseta_Prueba11 = ImportDataMultipleChannels('ECG-20-05-8H.txt',4);
data_camiseta_Prueba11 = camiseta_Prueba11(time_vector);
camiseta_Prueba12 = ImportDataMultipleChannels('ECG-25-05-8H.txt',4);
data_camiseta_Prueba12 = camiseta_Prueba12(time_vector);
camiseta_Prueba13 = ImportDataMultipleChannels('ECG-27-05-8H.txt',4);
data_camiseta_Prueba13 = camiseta_Prueba13(time_vector);
camiseta_Prueba14 = ImportDataMultipleChannels('ECG-30-05-8H.txt',4);
data_camiseta_Prueba14 = camiseta_Prueba14(time_vector);
camiseta_Prueba15 = ImportDataMultipleChannels('ECG-01-06-8H.txt',4);
...
pantalon_Prueba5 = ImportDataMultipleChannels('ECG-25-04-8H.txt',5);
data_pantalon_Prueba5 = pantalon_Prueba2(time_vector);
pantalon_Prueba6 = ImportDataMultipleChannels('ECG-27-04-8H.txt',5);
data_pantalon_Prueba6 = pantalon_Prueba3(time_vector);
pantalon_Prueba7 = ImportDataMultipleChannels('ECG-4-05-8H.txt',5);
data_pantalon_Prueba7 = pantalon_Prueba2(time_vector);
pantalon_Prueba8 = ImportDataMultipleChannels('ECG-11-05-8H.txt',5);
data_pantalon_Prueba8 = pantalon_Prueba8(time_vector);
pantalon_Prueba9 = ImportDataMultipleChannels('ECG-15-05-8H.txt',5);
data_pantalon_Prueba9 = pantalon_Prueba9(time_vector);
pantalon_Prueba10 = ImportDataMultipleChannels('ECG-18-05-8H.txt',5);
data_pantalon_Prueba10 = pantalon_Prueba10(time_vector);
pantalon_Prueba11 = ImportDataMultipleChannels('ECG-20-05-8H.txt',5);
data_pantalon_Prueba11 = pantalon_Prueba11(time_vector);
pantalon_Prueba12 = ImportDataMultipleChannels('ECG-25-05-8H.txt',5);
data_pantalon_Prueba12 = pantalon_Prueba12(time_vector);
pantalon_Prueba13 = ImportDataMultipleChannels('ECG-27-05-8H.txt',5);
data_pantalon_Prueba13 = pantalon_Prueba13(time_vector);
pantalon_Prueba14 = ImportDataMultipleChannels('ECG-30-05-8H.txt',5);
data_pantalon_Prueba14 = pantalon_Prueba14(time_vector);
pantalon_Prueba15 = ImportDataMultipleChannels('ECG-01-06-8H.txt',5);
