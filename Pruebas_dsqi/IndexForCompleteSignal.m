...
function [kSQI_01,sSQI_01, pSQI_01, cSQI_01, basSQI_01,dSQI_01,geometricMean,averageIndex] = IndexForCompleteSignal(ECG)
      ecg = importdata(ECG);
      ecg_values = ecg.data;
      data = ecg_values(:,3);
      ...
      [kSQI,sSQI, pSQI, cSQI,basSQI] = IndexCalculation(data_s,qrs_seconds); %index calculation
      ...
      indexes = [kSQI_01,sSQI_01,pSQI_01,cSQI_01,basSQI_01,dSQI_01];
