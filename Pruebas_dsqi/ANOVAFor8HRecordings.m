...
group_length = length(indexes_pantalon{1});
group = [repmat('P1',group_length,1);repmat('P2',group_length,1);repmat('P3',group_length,1);repmat('P4',group_length,1)];

%ANOVA para top
top = [indexes_top{1},indexes_top{2},indexes_top{3},indexes_top{4}];
p_top = anova1(top,group,"off");
fprintf("P-value para top: %f\n",p_top);

%ANOVA para camiseta 
camiseta = [indexes_camiseta{1},indexes_camiseta{2},indexes_camiseta{3},indexes_camiseta{4}];
p_camiseta = anova1(camiseta,group,"off");
fprintf("P-value para camiseta: %f\n",p_camiseta);

%ANOVA para pantalon
pantalon = [indexes_pantalon{1},indexes_pantalon{2},indexes_pantalon{3},indexes_pantalon{4}];
p_pantalon = anova1(pantalon,group,"off");
fprintf("P-value para pantalon: %f\n",p_pantalon);
