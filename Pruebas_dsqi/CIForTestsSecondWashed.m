...
top_Prueba2 = ImportDataMultipleChannels('ECG-30-05-8H.txt',3);
...
camiseta_Prueba2 = ImportDataMultipleChannels('ECG-30-05-8H.txt',4);
...
pantalon_Prueba2 = ImportDataMultipleChannels('ECG-30-05-8H.txt',5);
...
CIMedian_topT4T14 = estimateCIMedian(indexes_top{1},indexes_top{2},alph,iter);
CIMean_topT4T14 = estimateCIMean(indexes_top{1},indexes_top{2},alph,iter);

%confidence intervals for the t-shirt
CIMedian_camT4T14 = estimateCIMedian(indexes_camiseta{1},indexes_camiseta{2},alph,iter);
CIMean_camT4T14 = estimateCIMean(indexes_camiseta{1},indexes_camiseta{2},alph,iter);

%confidence intervals for the pant
CIMedian_pantT4T14 = estimateCIMedian(indexes_pantalon{1},indexes_pantalon{2},alph,iter);
CIMean_pantT4T14 = estimateCIMean(indexes_pantalon{1},indexes_pantalon{2},alph,iter);