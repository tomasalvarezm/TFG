...
CIMedian_topT4T12 = estimateCIMedian(indexes_top{1},indexes_top{2},alph,iter);
CIMean_topT4T12 = estimateCIMean(indexes_top{1},indexes_top{2},alph,iter);

%confidence intervals for the t-shirt
CIMedian_camT4T12 = estimateCIMedian(indexes_camiseta{1},indexes_camiseta{2},alph,iter);
CIMean_camT4T12 = estimateCIMean(indexes_camiseta{1},indexes_camiseta{2},alph,iter);

%confidence intervals for the pant
CIMedian_pantT4T12 = estimateCIMedian(indexes_pantalon{1},indexes_pantalon{2},alph,iter);
CIMean_pantT4T12 = estimateCIMean(indexes_pantalon{1},indexes_pantalon{2},alph,iter);