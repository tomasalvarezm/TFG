...
pantalon_Prueba3 = ImportDataMultipleChannels('ECG-27-04-8H.txt',5);
data_pantalon_Prueba3 = pantalon_Prueba3(time_vector);

data_pantalon = {data_pantalon_Prueba1,data_pantalon_Prueba2,data_pantalon_Prueba3};
...
%CONFIDENCE INTERVALS TEST 30-03 VS 25-04
...
%CONFIDENCE INTERVALS TEST 30-03 VS 27-04

%confidence intervals for the top
CIMedian_top2 = estimateCIMedian(indexes_top{1},indexes_top{3},alph,iter);
CIMean_top2 = estimateCIMean(indexes_top{1},indexes_top{3},alph,iter);

%confidence intervals for the t-shirt
CIMedian_cam2 = estimateCIMedian(indexes_camiseta{1},indexes_camiseta{3},alph,iter);
CIMean_cam2 = estimateCIMean(indexes_camiseta{1},indexes_camiseta{3},alph,iter);

%confidence intervals for the pant
CIMedian_pant2 = estimateCIMedian(indexes_pantalon{1},indexes_pantalon{3},alph,iter);
CIMean_pant2 = estimateCIMean(indexes_pantalon{1},indexes_pantalon{3},alph,iter);