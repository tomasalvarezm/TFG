...
for i = 1:length(files) 
    file = files{i} ;
    [kSQI_01_v,sSQI_01_v, pSQI_01_v, SQI_rel_powerLine_01_v,cSQI_01_v, basSQI_01_v,dSQI_01_v,geometricMean_V,averageGeometricMean] = mSQI(ImportPluxData(file,3 ), originalFSBitalino);
